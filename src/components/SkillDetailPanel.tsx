...
import { EFFECT_PRESETS, EffectShape, ProjectileType, Skill } from '../lib/skillSystem';
...
export function SkillDetailPanel({
  ...
  const projectileWithDuration = skill.projectile as Skill['projectile'] & { duration?: number };
  const projectileDuration = projectileWithDuration.duration || 2000;
                ...
                <TabsContent value='projectile' className='m-0 space-y-2'>
                  ...
                  {skill.projectile.type !== 'none' && (
                    <>
                      ...
                      <div className='space-y-1.5'>
                        <Label className='text-xs'>
                          지속시간: {(projectileDuration / 1000).toFixed(1)}초
                        </Label>
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            onUpdate(skill.id, {
                              projectile: {
                                ...skill.projectile,
                                duration: value,
                              } as unknown as Skill['projectile'],
                            })
                          }
                          min={100}
                          max={5000}
