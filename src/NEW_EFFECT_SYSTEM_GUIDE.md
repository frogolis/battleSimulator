...
<EffectPreviewCanvasNew preset={EFFECT_PRESETS.projectile_fireball} width={800} height={400} />;
```
...
<GraphicsEffectEditorNew onPresetSelect={(preset) => console.log(preset)} showPreview={true} />;
```
